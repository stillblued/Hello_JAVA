...
public class Main extends JFrame {
	...
	private static final String[] MENU = { "딸기셔벗", "와인젤리", "팝콘", "스크램블에그", "코코뱅", "포크커틀릿", "고로케", "김치전", "핫도그", "라따뚜이",
			...
			"포토푀", "버섯라비올리" }; // 음식 종류
	protected static ArrayList<String> cook = new ArrayList<String>(); // 조리할 식재료 배열
	private String name; // 가게이름
	private static int money = 1000; // 소지금 (초기자본 : 1000)
	private static int exp = 0; // 경험치
	private static int level = 1; // 레벨
	private static final int STANDARD = 10; // 소지금, 경험치, 레벨 등의 기준점
	Customer custom = Customer.getType(level); // 난이도 선택
	String explain; // 랜덤 손님 메뉴
	public static int menuIndex; // 주문 인덱스
	...
	private static void customcursor() {
	...
	Main() {
		...
		restaurant.setBounds(80, 75, 850, 580);
		restaurant.setBorder(BorderFactory.createLineBorder(Color.BLACK));
		...
		sttBtn.setIcon(new ImageIcon(Main.class.getResource("/image/house.png")));
		...
		exitBtn.setIcon(new ImageIcon(Main.class.getResource("/image/over.png")));
		...
		strPerson.setIcon(new ImageIcon(Main.class.getResource("/image/person.png")));
		storyPanel1.add(strPerson);

		JLabel strDog1 = new JLabel();
		strDog1.setBackground(Color.WHITE);
		strDog1.setBounds(450, 158, 116, 102);
		strDog1.setIcon(new ImageIcon(Main.class.getResource("/image/dog(2).gif")));
		...
		strDog2.setIcon(new ImageIcon(Main.class.getResource("/image/dog(3).gif")));
		...
		customer1.setIcon(new ImageIcon(Main.class.getResource("/image/person1.png")));
		...
		customer2.setIcon(new ImageIcon(Main.class.getResource("/image/person2.png")));
		...
		customer3.setIcon(new ImageIcon(Main.class.getResource("/image/person3.png")));
		...
		customer4.setIcon(new ImageIcon(Main.class.getResource("/image/person4.png")));
		...
		customer5.setIcon(new ImageIcon(Main.class.getResource("/image/person5.png")));
		...
		dogDancing.setIcon(new ImageIcon(Main.class.getResource("/image/dog(1).gif")));
		...
		dogDefault.setIcon(new ImageIcon(Main.class.getResource("/image/dog(5).gif")));
		theDog.add(dogDefault);

		JPanel moneyPanel = new JPanel();
		moneyPanel.setBackground(SystemColor.inactiveCaption);
		moneyPanel.setBounds(597, 466, 204, 47);
		moneyPanel.setBorder(BorderFactory.createLineBorder(Color.BLACK));
		restaurant.add(moneyPanel);
		...
		servingBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (x == y) {
					...
					JOptionPane.showMessageDialog(null, "여기 계산이요! ^_^ +50P +10exp");
		...
		resultFood.setIcon(new ImageIcon(Main.class.getResource("/image/food_1.png")));
		...
		for (int i = 0; i < STUFF.length; i++) {
			...
			box[i].setBackground(SystemColor.inactiveCaption);
		...
		bgImg.setIcon(new ImageIcon(Main.class.getResource("/image/tile_background.png")));
